...
from rattlesnake.environment.sds_sys_id_environment import (
    SDSCommands,
    SDSMetadata,
    SDSEnvironment,
    sds_process,
...
# Sum-Decayed-Sines Environment
ENVIRONMENT_COMMANDS[ControlTypes.SDS] = SDSCommands
ENVIRONMENT_METADATA[ControlTypes.SDS] = SDSMetadata
ENVIRONMENT_CLASS[ControlTypes.SDS] = SDSEnvironment
ENVIRONMENT_PROCESS[ControlTypes.SDS] = sds_process
